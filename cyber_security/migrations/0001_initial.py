    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rule_config",
                    models.JSONField(default=dict, verbose_name="إعدادات القاعدة"),
                ),
                ...
                (
                    "is_mandatory",
                    models.BooleanField(default=False, verbose_name="إلزامية"),
                ),
                (
                    "created_at",
                    models.DateTimeField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "login_patterns",
                    models.JSONField(default=dict, verbose_name="أنماط تسجيل الدخول"),
                ),
                (
                    "access_patterns",
                    models.JSONField(default=dict, verbose_name="أنماط الوصول"),
                ),
                (
                    "activity_patterns",
                    models.JSONField(default=dict, verbose_name="أنماط النشاط"),
                ),
                (
                    "risk_score",
                    models.DecimalField(
                ...
                (
                    "anomalies_detected",
                    models.JSONField(default=list, verbose_name="الشذوذ المكتشف"),
                ),
                (
                    "security_recommendations",
                    models.JSONField(default=list, verbose_name="توصيات أمنية"),
                ),
                (
                    "last_analysis_date",
                    models.DateTimeField(
